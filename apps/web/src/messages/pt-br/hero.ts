export const Hero = {
  ...
  subtitle: 'Rápido, Simples e Poderoso',
  description:
  ...
  cta: {
    title: 'Pronto para mais recursos?',
    description:
      'Crie uma conta gratuita e tenha acesso a links personalizados, analytics detalhados e muito mais.'
  }
} as const;
