 ...
 */
// Keep the injected auth guard broad here. A generic plugin parameter causes
// Elysia to lose contextual typing for the handler context inside this factory.
export function createAnalyticsController(authGuard: AnyElysia = requireAuth) {
  return (
    new Elysia({ prefix: '/analytics' })
      .use(authGuard)
      ...
      .get(
        ...
        },
        {
          ...
          detail: {
            ...
            description:
              'Get complete analytics breakdown across all user links'
          },
          response: {
