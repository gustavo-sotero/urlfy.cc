 ...
 * Source: openapi-spec.json
 * Generator: scripts/generate-api-contracts.ts
 * Included path prefixes: ${edenClientPrefixes.join(', ')}
 * Do not edit this file by hand.
 */`;
}
...
function shouldIncludeEdenPath(path: string): boolean {
  return edenClientPrefixes.some(
...
function buildEdenRouteTree(spec: OpenAPIDocument): EdenRouteNode {
  ...
  for (const [path, pathItem] of Object.entries(spec.paths ?? {})) {
    if (!shouldIncludeEdenPath(path)) continue;
