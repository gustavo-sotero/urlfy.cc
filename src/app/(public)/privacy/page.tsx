      ...
      <article className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <section className="mt-8">
          ...
          <p>
            ...
            Privacidade explica como coletamos, usamos, armazenamos e protegemos
            suas informações em conformidade com a Lei Geral de Proteção de
            Dados (LGPD) e regulamentações internacionais como GDPR.
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>Endereço IP (anonimizado através de hash SHA-256 imediato)</li>
        ...
        <section className="mt-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Provedores de serviço:</strong> Empresas que nos ajudam a
              operar o Serviço (hospedagem, email)
            </li>
            <li>
        ...
        <section className="mt-8">
          ...
          <p className="mt-4">
            Para exercer esses direitos, acesse as configurações da sua conta ou
            entre em contato através de{' '}
            <a
              href="mailto:privacy@urlfy.cc"
        ...
        <section className="mt-8">
          ...
          <p>
            Seus dados são armazenados em servidores localizados no Brasil. Caso
            seja necessário transferir dados internacionalmente, garantimos
            proteções adequadas conforme exigido pela LGPD.
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          <p>
            ...
            intencionalmente dados de menores. Se tomarmos conhecimento de tais
            dados, os excluiremos imediatamente.
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          <p>
            ...
            mudanças significativas através do Serviço ou por e-mail.
        ...
        <section className="mt-8">
          ...
          <p>
            Para questões sobre privacidade ou para exercer seus direitos, entre
        ...
        <section className="mt-8">
          ...
          <p>
            Se não estivermos satisfeitos com nossa resposta, você tem o direito
            de apresentar uma reclamação à Autoridade Nacional de Proteção de
            Dados (ANPD) no Brasil.
          </p>
        </section>
      </article>
    </div>
