          ...
          <div className="mx-auto max-w-4xl space-y-8 text-center">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 rounded-full border bg-muted px-4 py-2 text-sm">
                ...
                <span>Projeto de Portfólio & Pesquisa</span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    habilidades técnicas em arquitetura de software, performance
                    engineering e boas práticas de desenvolvimento. Não se trata
                    de um produto comercial, mas sim de um estudo de caso e
                    portfólio.
                  </p>
                </div>
              </div>
        ...
        <section className="border-t bg-muted/30 py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl space-y-6 text-center">
              ...
              <p className="text-muted-foreground">
                Mergulhe nos detalhes técnicos através da documentação completa
                da API e código-fonte no GitHub.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Button asChild variant="default">
                  <Link href="/api/docs">
