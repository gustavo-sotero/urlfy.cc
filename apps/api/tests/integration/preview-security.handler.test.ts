...
// Dynamic chainable builder used by BOTH @urlfy/data and @/db/index mocks
// so tests can override `currentSelectResult` per-test and both mocks reflect it
const dynamicChaineableFactory = () => {
...
// Register both module paths — apps/api server uses @urlfy/data; keep @/db/index for compat
mock.module('@urlfy/data', () => dynamicChaineableFactory());
mock.module('@/db/index', () => dynamicChaineableFactory());
