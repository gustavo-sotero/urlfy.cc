...
export function SettingsPageClient({
  ...
  const nameValue = nameDraft ?? initialSession?.user?.name ?? '';
  const emailValue = initialSession?.user?.email ?? '';
  const twoFactorEnabled = initialSession?.user?.twoFactorEnabled ?? false;
