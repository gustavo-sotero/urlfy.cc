...
## 📦 Módulo 1: Infraestrutura & Core Setup — [Ver módulo](modules/module-01-infrastructure.md)
...
| **1.7** | **Health Endpoints:** Implementação de `/api/v1/health` e `/api/v1/health/ready` com verificação de dependências (DB, Redis).         | PRD 6                  |
...
## 🔐 Módulo 2: Autenticação & Identidade — [Ver módulo](modules/module-02-authentication.md)
...
## 🔗 Módulo 3: Gestão de Links (Core Domain) — [Ver módulo](modules/module-03-links.md)
...
## 🚀 Módulo 4: Redirect Engine (Hot Path) — [Ver módulo](modules/module-04-redirect.md)
...
## 📊 Módulo 5: Analytics & Processamento de Dados — [Ver módulo](modules/module-05-analytics.md)
...
## 🛡️ Módulo 6: Segurança & Compliance — [Ver módulo](modules/module-06-security.md)
...
| **6.8**  | **GDPR/LGPD Endpoints:** `GET /api/v1/me/export` para exportação de dados e `DELETE /api/v1/me/data` para exclusão (72h deadline).     | RF-35 a RF-38    |
...
## 🖥️ Módulo 7: Interfaces de Usuário (Client) — [Ver módulo](modules/module-07-ui.md)
